...
begin
  ...
  // Однако всё же бывает что нужны результаты всех сложенных/умноженных очередей
  ...
  // Теперь выводит строку "1 2", потому что это то, что вернуло JoinIntoString для массива результатов
