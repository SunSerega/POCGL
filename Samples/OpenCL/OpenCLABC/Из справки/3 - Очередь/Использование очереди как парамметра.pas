...
//ToDo Сейчас этот код не работает, но только потому что нету .Clone
// - пока что его невозможно добавить из за issue компилятора #2070
// - но в целом, понять что имелось в виду в справке - можно и не запуская этот код, а только внимательно просмотрев его
