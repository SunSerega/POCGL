...
// И некоторые очереди (как выполнение кёрнелов) могут давать разные результаты, если выполнить их лишний раз
// 
...
// 
// Кёрнел создаётся через индесной свойтсво ProgramCode:
// code['KernelName']
// Где code имеет тип ProgramCode
// А 'KernelName' - имя подпрограммы-кёрнела в исходном коде (регистр важен!)
// 
