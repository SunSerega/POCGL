...
begin
  try
    if System.IO.Directory.Exists('GLExtSpecFormating\ext spec texts') then System.IO.Directory.Delete('GLExtSpecFormating\ext spec texts',true);
    ...
    begin
      ...
      var fname2 := fname.Replace('Reps\OpenGL-Registry\extensions', 'GLExtSpecFormating\ext spec texts');
