...
- Если поставить начала всех 3 векторов в точку (0;0;0), а камеру в точку (a+b+c) и направить
в точку (0;0;0) - вектора a, b и c будут расположены по часовой стрелке вокруг центра экрана.
